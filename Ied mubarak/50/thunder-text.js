...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Pastikan lagu diputar setelah user interaksi (untuk mengatasi pembatasan autoplay)
  document.body.addEventListener("click", function () {
    audio.play();
  });

  // Coba langsung play (beberapa browser mengizinkan autoplay tanpa interaksi)
  audio.play().catch((error) => {
    console.log("Autoplay dicegah, pengguna harus berinteraksi dulu.");
  });
});
...
function album() {
  window.location.href = "../album code/album.html";
}

function kucing() {
  window.location.href = "../74/claw-machine.html";
}

function paus() {
  window.location.href = "../44/interactive-whale.html";
}